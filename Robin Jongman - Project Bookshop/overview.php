<?php
/* Toont hetzelfde boekenoverzicht en dezelfde filters als index.php, deze aparte pagina is handig voor directe links of voor print/export zonder de rest van index.php */
