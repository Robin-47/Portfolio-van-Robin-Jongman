...
class Product
{
    ...
    public function insert()
    {
        ...
        // Voorkomt SQL-injectie door de invoer te ontsmetten
    ...
    public static function findAll()
    {
        ...
        $query = "SELECT * FROM products"; // SQL-query om alle producten op te halen
        $result = $conn->query($query);

        $products = [];

        // Zet elke rij om in een Product-object
    ...
    // Vindt een product op basis van de ID
    public static function findId($productId)
    {
        $conn = Database::start();

        $query = "SELECT * FROM products WHERE product_id = '$productId'"; // SQL-query om een specifiek product op te halen
        $result = $conn->query($query);
